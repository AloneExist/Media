!(function (e, t) {
  ...
  return (
    ...
    (Z.innerHTML =
      ...
      '.cover_big{opacity:0;position:fixed;background:rgba(255,255,255,.7);top:0;left:0;z-index:2;transition:all .1s ease;}' +
